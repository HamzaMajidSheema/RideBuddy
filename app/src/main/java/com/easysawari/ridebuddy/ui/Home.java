...
public class Home extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String utype = user.get(SessionManagement.KEY_UTYPE);
        ...
        tv_type.setText(utype);
        header.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(utype.equals("RideOwner"))
                {
                    Intent intent1=new Intent(Home.this,RIdeOwner.class);
                    intent1.putExtra("key1",name);
                    intent1.putExtra("key2",email);
                    intent1.putExtra("key3",utype);
                    startActivity(intent1);

                }
                else if (utype.equals("Customer")){
                    Intent intent3=new Intent(Home.this,Customer.class);
                    intent3.putExtra("key1",name);
                    intent3.putExtra("key2",email);
                    intent3.putExtra("key3",utype);
